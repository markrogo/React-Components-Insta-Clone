...
- [x]  Use what you learned yesterday to set up state to keep track of the posts. -- (NOT SURE I'VE LEARNED THIS)
...
- [ ]  Create more dummy data in the dummy-data.js file and add search functionality to the search bar. One way to do this is with a filter method. -- CREATED TWO NEW POSTS, NOW HAVE TO GET SEARCH WORKING
- [ ]  Implement the ability to add comments to a post using an input.
- [x]  Finish styling all of the application and get your instagram clone to closely resemble the given design spec. -- THIS SEEMS TO COME FOR FREE
